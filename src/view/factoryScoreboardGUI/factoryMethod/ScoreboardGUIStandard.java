...
public class ScoreboardGUIStandard implements FactoryScoreboardGUI, GraphicsScoreboard {
    ...
    private void createGraphics() {
        ...
        panelScore.add(this.getUnionComponent(List.of(this.concreteScoreboardGUI.getTxtSearchName(),
